...
import { BookOpen, Mail, Phone, ArrowRight, BookText, Headphones, Globe } from "lucide-react"
    ...
    <div className="min-h-screen font-sans dark:bg-neutral-900">
      ...
      >
        ...
        {/* <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-emerald-950 via-emerald-900 to-teal-900 dark:from-emerald-950 dark:via-emerald-950 dark:to-teal-950"></div>
          <div
            className="absolute top-0 left-0 w-full h-full opacity-10"
            style={{
              backgroundImage:
                "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fillRule='evenodd'%3E%3Cg fill='%23ffffff' fillOpacity='0.2'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4H6zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E\")",
            }}
          ></div>
          <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-emerald-600/20 rounded-full blur-3xl"></div>
          <div className="absolute -top-32 -left-32 w-96 h-96 bg-teal-600/20 rounded-full blur-3xl"></div>
        </div> */}

        {/* Decorative Elements */}
        <div className="absolute top-1/4 left-10 w-1 h-32 bg-gradient-to-b from-emerald-400 to-transparent opacity-60"></div>
        <div className="absolute top-1/3 right-10 w-1 h-48 bg-gradient-to-b from-emerald-400 to-transparent opacity-60"></div>
        <div className="absolute bottom-1/4 left-1/4 w-32 h-1 bg-gradient-to-r from-transparent to-emerald-400 opacity-60"></div>
          ...
          <div className="max-w-3xl">
            ...
            <AnimatedElement animation="fade-up" duration={1000} delay={500}>
              <h1 className="font-serif text-5xl md:text-7xl font-bold mb-6 leading-tight">
                <span className="block">Editora</span>
                <span className="text-emerald-300 italic">Pensieri</span>
              </h1>
            </AnimatedElement>
      ...
      {/* Rest of the sections remain the same, just add dark mode classes */}
            ...
            <div className="md:w-1/3">
              <div className="sticky top-32">
                <AnimatedElement animation="fade-right" duration={1000}>
                  ...
                  <h2 className="font-serif text-5xl font-bold mb-6 text-neutral-800 dark:text-white">
                    Nossa História
                  </h2>
                  <p className="text-neutral-600 dark:text-neutral-400 italic text-xl mb-8 font-serif">
                    "Desde 1993, inovando no mercado editorial brasileiro com propósito e visão."
                  </p>
                </AnimatedElement>

                <AnimatedElement animation="fade-up" duration={1000} delay={300} className="hidden md:block relative">
                  <div className="absolute inset-0 bg-emerald-900/10 dark:bg-emerald-900/30 backdrop-blur-sm z-10"></div>
                  <img
                    src="/placeholder.svg?height=400&width=300&text=Pensieri 1993"
                    alt="Fundação da Editora Pensieri"
              ...
              <div className="prose prose-lg dark:prose-invert max-w-none">
                <AnimatedElement animation="fade-left" duration={1000}>
                  <p className="text-neutral-700 dark:text-neutral-300 text-xl leading-relaxed mb-8 first-letter:text-5xl first-letter:font-serif first-letter:font-bold first-letter:text-emerald-800 dark:first-letter:text-emerald-400 first-letter:mr-2 first-letter:float-left">
                    A Editora Pensieri nasceu em 1993, com propósito de inovar no mercado editorial brasileiro. Seu
                    primeiro lançamento foi "Salto Mortal", do premiado escritor cubano Luis Manuel Garcia – uma obra
                    bilíngue português-espanhol, a primeira do tipo no Brasil, lançada no embalo do surgimento do
                    Mercosul. O livro teve grande repercussão na imprensa e marcou o início da proposta inovadora da
                    editora.
                  </p>
                </AnimatedElement>

                <AnimatedElement animation="fade-up" duration={1000} delay={200} className="my-16 relative">
                ...
                <AnimatedElement animation="fade-left" duration={1000} delay={300}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-16">
                  <AnimatedElement animation="fade-up" duration={1000} delay={400}>
                    <div className="bg-neutral-50 dark:bg-neutral-800 p-8 border-l-4 border-emerald-500 shadow-sm">
                      ...
                      <p className="text-neutral-700 dark:text-neutral-300">
                        "O Separatismo no Brasil", de Newton Duarte Molon, uma análise profunda sobre os movimentos
                        separatistas no país, com ilustrações de Luis Fernando Verissimo.
                      </p>
                    </div>
                  </AnimatedElement>
                ...
                <AnimatedElement animation="fade-left" duration={1000} delay={700}>
      ...
      {/* Editora Section */}
      <section id="editora" className="py-32 bg-neutral-50 dark:bg-neutral-800 relative overflow-hidden">
        {/* Decorative Elements */}
        <div className="absolute top-0 left-0 w-full h-20 bg-gradient-to-b from-white dark:from-neutral-800 to-transparent"></div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <AnimatedElement animation="fade-up" duration={1000} className="max-w-3xl mx-auto text-center mb-20">
            ...
            <p className="text-neutral-600 dark:text-neutral-300 text-xl">
              Combinando tradição editorial com inovação tecnológica para criar conteúdos que educam e inspiram.
            </p>
          </AnimatedElement>
                ...
                {[
                  {
                    ...
                    title: "Publicações Tradicionais",
                    description:
                      "Mantemos o compromisso com a qualidade editorial em nossas publicações impressas, valorizando o contato tátil com o conhecimento.",
                  ...
                  },
                  {
                    ...
                    description:
                      "Expandimos para o universo digital com e-books e conteúdos interativos, democratizando o acesso ao conhecimento.",
                  ...
                  },
                  {
                    ...
                    title: "Audiobooks",
                    description:
                      "Transformamos nossas obras em experiências auditivas imersivas, narradas por profissionais talentosos.",
                  ...
                  <div
                    key={index}
                    className={`p-10 rounded-none border-l-4 border-l-emerald-500 shadow-sm ${item.color} transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md`}
                  >
                    <div className="flex items-start">
                      <div className="mr-6">
                        <div className={`w-16 h-16 ${item.iconBg} rounded-none flex items-center justify-center`}>
                          {item.icon}
                        </div>
                      </div>
                      <div>
                        <h3 className="font-serif text-2xl font-bold mb-3 text-neutral-800 dark:text-white">
                          {item.title}
                        </h3>
        ...
        <div className="absolute bottom-0 left-0 w-full h-20 bg-gradient-to-t from-white dark:from-neutral-800 to-transparent"></div>
      </section>

      {/* Biblioteca Section */}
      <section id="biblioteca" className="py-32 bg-white dark:bg-neutral-900 relative">
        {/* Decorative Elements */}
  ...
  {[
    ...
    <div key={index} className="group relative overflow-hidden transition-all duration-500">
      <div className="relative aspect-[2/3] overflow-hidden">
        ...
        <div className="absolute top-3 right-3 bg-white/90 text-emerald-800 text-xs font-bold px-2 py-1">
          {book.year}
        </div>
        ...
        {/* <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
          <div className="p-6 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
            <Button variant="outline" size="sm" className="w-full text-white border-white hover:bg-white/20">
              Ver detalhes
            </Button>
          </div>
        </div> */}
      ...
      <div className="pt-4">
        ...
        <p className="text-sm text-neutral-500 dark:text-neutral-400">{book.author}</p>
          ...
          {/* <AnimatedElement animation="fade-up" duration={1000} delay={800} className="text-center mt-20">
            <Button className="bg-emerald-700 hover:bg-emerald-800 text-white rounded-none px-10 py-7 group">
              <span className="text-lg">Explorar catálogo completo</span>
      ...
      {/* Comunicação Section */}
      <section id="comunicação" className="py-32 bg-neutral-50 dark:bg-neutral-800 relative overflow-hidden">
        {/* Decorative Elements */}
        <div className="absolute top-0 left-0 w-full h-20 bg-gradient-to-b from-white dark:from-neutral-800 to-transparent"></div>
              ...
              <div className="grid grid-cols-1 gap-10">
                <AnimatedElement animation="fade-left" duration={1000} delay={200}>
                  <div className="bg-white dark:bg-neutral-800 shadow-md overflow-hidden">
                    ...
                    <div className="p-10">
                      <h3 className="font-serif text-3xl font-bold mb-6 text-neutral-800 dark:text-white">
                        Assessoria de Imprensa
                      </h3>
                      <p className="text-neutral-600 dark:text-neutral-300 text-lg mb-8">
                        Construímos pontes entre sua marca e os veículos de comunicação, ampliando seu alcance e
                        credibilidade no mercado.
                      </p>
                      <ul className="space-y-4">
                        {["Releases estratégicos", "Relacionamento com a mídia", "Gestão de crise"].map(
                          (item, index) => (
                            <li
                              key={index}
                              className="flex items-center text-neutral-700 dark:text-neutral-300 text-lg"
                            >
                              <div className="w-2 h-2 bg-emerald-500 mr-4"></div>
                              {item}
                            </li>
                          ),
                        )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <AnimatedElement animation="fade-left" duration={1000} delay={400}>
                    <div className="bg-white dark:bg-neutral-800 shadow-md overflow-hidden">
                      ...
                      <div className="p-8">
                        <h3 className="font-serif text-2xl font-bold mb-4 text-neutral-800 dark:text-white">
      ...
      {/* Contato Section */}
      <section id="contato" className="py-32 bg-white dark:bg-neutral-900 relative">
        {/* Decorative Elements */}
        <div className="absolute top-0 left-0 w-full h-20 bg-gradient-to-b from-neutral-50 dark:from-neutral-900 to-transparent"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-16">
            ...
            <AnimatedElement animation="fade-up" duration={1000}>
              ...
              <p className="text-neutral-400 text-lg mb-8 max-w-md leading-relaxed">
                Ideias que conectam, mensagens que transformam. Desde 1993, a Editora Pensieri tem sido pioneira em
                inovação editorial, combinando tradição e tecnologia.
              </p>
            </AnimatedElement>
